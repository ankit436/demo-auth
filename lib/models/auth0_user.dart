...
class Auth0User {
  ...
  @JsonKey(name: 'https://getstream.demo_auth/user_token')
  final String streamChatUserToken;

  @JsonKey(name: 'https://users.demo_auth/roles')
  final List<Auth0Role> roles;

  @JsonKey(name: 'https://users.demo_auth/permissions')
  final List<Auth0Permission> permissions;

  @JsonKey(name: 'https://employees.demo_auth/id', defaultValue: [])
